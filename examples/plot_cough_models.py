...
def main():
    """Generate cough model comparison plots."""
    # Output directory
    ...
    for label, params, color, linestyle in examples_params:
        ...
        ax2_lin.plot(t_s, q_lps, label=label, linestyle=linestyle, color=color, linewidth=2)
        ax2_norm.plot(tau, m, label=label, linestyle=linestyle, color=color, linewidth=2)
    ...
    ax2_lin.plot(t_test, q_test, label="Test: 70kg, 1.93m Male", linestyle=":", color="black", linewidth=2.5)
    ax2_norm.plot(tau_test, m_test, label="Test: 70kg, 1.93m Male", linestyle=":", color="black", linewidth=2.5)
